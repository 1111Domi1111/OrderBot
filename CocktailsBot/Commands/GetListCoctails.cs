...
namespace CocktailsBot.Commands
{
    class GetListCoctails : Command
    {
        ...
        public override async void Execute(TelegramBotClient _bot, Message e, List<Command> _commands)
        {
            ...
            var result = await api.GetListCoctails();
            SendInf(result, e);
            EndComand();
        }
        ...
        {
            await Bot.SendTextMessageAsync(message.From.Id, $"List coctails\n\n" +
