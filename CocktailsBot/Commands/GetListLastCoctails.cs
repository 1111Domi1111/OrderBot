...
namespace CocktailsBot.Commands
{
    class GetListLastCoctails: Command
    {
        ...
        public override async void Execute(TelegramBotClient _bot, Message e, List<Command> _commands)
        {
            ...
            var result = await api.GetListLastCoctails();
            SendInf(result, e);
            EndComand();
        }
        ...
        {
            await Bot.SendTextMessageAsync(message.From.Id, $"new coctails\n\n" +
